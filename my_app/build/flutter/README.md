...
* `my_app` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `my_app` - executable or bundle name on disk.
* `my_app` - display name shown in window titles and about app dialogs.
